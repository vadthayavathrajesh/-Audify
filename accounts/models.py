...
class FBVideoLinks(models.Model):
    video_link = models.URLField(max_length=200)
    customer = models.ForeignKey(Customer, null=True, on_delete=models.CASCADE)
    title = models.CharField(max_length=200)
    video_file = models.FileField(upload_to='videos/')
    ...
    def __str__(self):
        return self.title
class TWVideoLinks(models.Model):
    video_link = models.URLField(max_length=200)
    customer = models.ForeignKey(Customer, null=True, on_delete=models.CASCADE)
    title = models.CharField(max_length=200)
    video_file = models.FileField(upload_to='videos/')
...
class FBCommentLinks(models.Model):
    fb_link = models.ForeignKey(FBVideoLinks,on_delete=models.CASCADE)
    customer = models.ForeignKey(Customer, null=True, on_delete=models.CASCADE)
    comments = models.CharField(max_length=200)
    timestamps = models.CharField(max_length=200)
    def __str__(self):
        return self.video_link.title
class TWCommentLinks(models.Model):
    tw_link = models.ForeignKey(TWVideoLinks,on_delete=models.CASCADE)
    customer = models.ForeignKey(Customer, null=True, on_delete=models.CASCADE)
    comments = models.CharField(max_length=200)
    timestamps = models.CharField(max_length=200)
    def __str__(self):
