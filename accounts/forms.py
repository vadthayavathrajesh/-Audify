...
class CommentLinkForm(forms.ModelForm):
    class Meta:
        model = CommentLinks
        fields = ('comments','timestamps')
class FBLinkUploadForm(forms.ModelForm):
    class Meta:
        model = FBVideoLinks
        fields = ('video_link', 'title')
class FBCommentLinkForm(forms.ModelForm):
    class Meta:
        model = FBCommentLinks
        fields = ('comments','timestamps')
class TWLinkUploadForm(forms.ModelForm):
    class Meta:
        model = TWVideoLinks
        fields = ('video_link', 'title')
class TWCommentLinkForm(forms.ModelForm):
    class Meta:
        model = TWCommentLinks
        fields = ('comments','timestamps')
